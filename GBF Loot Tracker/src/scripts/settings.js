...
printSettingsButton.addEventListener("click", logSettings);
const resetSettingsButton = document.getElementById("resetSettingsButton");
resetSettingsButton.addEventListener("click", resetSettings);
const recalculateDataButton = document.getElementById("recalculateDataButton");
recalculateDataButton.addEventListener("click", recalculateData);
const fixDataButton = document.getElementById("fixDataButton");
fixDataButton.addEventListener("click", dataNorm);
...
async function dataNorm(){
    let sephiraData = await getObjectFromLocalStorage("Sephira Boxes");
    const fixedSephiraData = removeKeyFromLoot(sephiraData, "boxIdundefined");
    ...
    mergeStageData(stage1, stage2, stage1Key);
}

function removeKeyFromLoot(stageData, key){
...
*/
function mergeStageData(stage1, stage2, newKey){
    var newStageData;
    ...
    const stage1Valid = validateStageData(stage1Data);
    const stage2Valid = validateStageData(stage2Data)
    ...
    if (!stage1Valid && !stage2Valid){
        ...
        newStageData = mergeStageDataOpperation(stage1Data, stage2Data);}
 ...
 */
function mergeStageDataOpperation(stage1Data, stage2Data){
...
*/
function validateStageData(stageData){
    // console.log(stageData);
    try{
...
async function initSettings(){
    ...
    checkboxes.forEach(function (checkbox) {
        ...
        checkbox.addEventListener("change", (e) => updateSetting(e));
    });
}
